...
public class AddStudentWindow extends JFrame {
    ...
    AddStudentWindow(String title){
        ...
        okButton.setBounds(30, 380, 300, 50);
        panel.add(okButton);
        ...
        okButton.addActionListener(e -> {
            boolean result = Student.createStudent(nameField.getText(), groupNumberField.getText(), dormitoryNumberField.getText(),
